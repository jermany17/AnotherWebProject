package com.example.AnotherWebProject.config;

import com.example.AnotherWebProject.auth.service.UserDetailService;
        ...
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(
                                ...
                                "/s3/upload", "/s3/delete",
                                "/recipes/**", "/ingredients/**", "/reviews/**").authenticated()
                        .anyRequest().denyAll()
                )
